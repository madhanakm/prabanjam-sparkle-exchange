...
const PrabanjamJewelleryDetail = () => {
  ...
  const fetchGalleryImages = async () => {
    try {
      const response = await api.get('/company-gallery/prabanjam-jewellery');
          ...
          <div className="max-w-6xl mx-auto">
            <Card className="p-8 md:p-12 mb-16">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                Established in 2025, Prabanjam Jewellery Limited has been at the forefront of the jewelry 
