...
const SiruvaniComplexDetail = () => {
  ...
  const fetchGalleryImages = async () => {
    try {
      const response = await api.get('/company-gallery/siruvani-complex');
          ...
          <div className="max-w-6xl mx-auto">
            <Card className="p-8 md:p-12 mb-16">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                Established in 2019, Siruvani Complex stands as a landmark commercial development in the heart of 
